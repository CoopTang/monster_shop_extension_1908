...
describe Order, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'packaged?' do
      ...
      order_2 = @user.orders.create!(name: 'Meg', address_id: @home.id, status: 1)
  ...
  describe 'class_method' do
    it 'sort_orders' do
      ...
      order_1 = user_1.orders.create(name: 'User 1', address_id: home.id, status: 2)
      order_2 = user_1.orders.create(name: 'User 2', address_id: home.id, status: 3)
      order_3 = user_1.orders.create(name: 'User 1', address_id: home.id, status: 1)
      order_4 = user_1.orders.create(name: 'User 2', address_id: home.id, status: 0)
